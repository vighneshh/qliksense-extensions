						...
						model.getProperties().then( function ( reply ) {
							...
							app.getObject('CurrentSelections').then(function(model){
								...
								'<div class="modal-content">' +
								  ...
								  '<div class="modal-body">' +
									...
									'<div id="ExportEditor" style="position: fixed; z-index:2; width: 100%; height: 100%; left: 0; top: 125px;background:#ccc;opacity:0.8">' +
										'<h1 class="previewmsg">&diams; Wait Until Table Preview Then Click on XLS &diams;</h1>' +
								...
								XLSButton.onclick = function() {
									...
									// $('#QVSmartExport02 .qv-st-header-cell').css('border','1px solid black');
									// $('#QVSmartExport02 .qv-st-data-cell').css('border','1px solid black');
									// $('#QVSmartExport02 table').css('border','1px solid black');
									var tablename = document.getElementById('QVSmartExport02').getElementsByClassName('qv-object-title-text')[0].outerText;
									var el = '<caption>'+tablename+'</caption>';
									// for table
									$('#QVSmartExport02 table .qv-st-header-cell').css('border','1px solid black');
									$('#QVSmartExport02 table .qv-st-data-cell').css('border','1px solid black');
									$('#QVSmartExport02 table .qv-st-header-cell.qv-st-header-cell-search').css('border','1px solid black');
									

									// for pivot
									$('#QVSmartExport02 .qv-pt .cell.header.top').css('border','1px solid black');
									$('#QVSmartExport02 .qv-pt .cell').css('border','1px solid black');
									$('#QVSmartExport02 .qv-pt .cell.header.left').css('border','1px solid black');
									$('#QVSmartExport02 .qv-pt .cell.header.left').css('border','1px solid black');
									
									// for background color and color
									$('#QVSmartExport02 .qv-st-interactive:not(.qv-st-selections-active):not(.qv-st-reordering-active) .qv-st-header:not(.qv-st-custom-header) .qv-st-header-cell-search,.qv-st-navigatable:not(.qv-st-selections-active):not(.qv-st-reordering-active) .qv-st-header-sortable:not(.qv-st-custom-header)').css({"background-color": '#052354 !important', "color": '#fff !important'});
									$('#QVSmartExport02 .qv-pt .cell.header.top').css({'background-color':'#052354 !important','color':'#fff'});
									$('#QVSmartExport02 .qv-object-pivot-table .qv-inner-object table .cell.null-value').css('background-color','rgb(183, 183, 183) !important');


									$('#QVSmartExport02 .qv-object-title-text').remove();
									$('#QVSmartExport02 .qv-object-title-text').remove();
									$('#QVSmartExport02 .qv-object-subtitle').remove();
									$('#QVSmartExport02 table').first().prepend(el);

									// added center-right
									
									$('#QVSmartExport02 .qv-object-pivot-table .qv-inner-object table td.cell.data').css('text-align','right !important');
